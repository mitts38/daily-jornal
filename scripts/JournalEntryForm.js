  ...
  const render = () => {
    contentTarget.innerHTML =`
      ...
      <div class="moodFilter__radio">
        <input type="radio" id="moodChoice" name="mood" value="happy">
        <label for="moodChoice1">Happy</label>
        <input type="radio" id="moodChoice" name="mood" value="ok">
        <label for="moodChoice2">ok</label>  
        <input type="radio" id="moodChoice" name="mood" value="sad">
